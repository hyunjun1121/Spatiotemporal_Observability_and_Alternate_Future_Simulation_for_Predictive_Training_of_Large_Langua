...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--hf_name", default="Salesforce/wikitext", help="HF datasets identifier")
    parser.add_argument("--hf_config", default="wikitext-103-v1", help="HF datasets configuration")
